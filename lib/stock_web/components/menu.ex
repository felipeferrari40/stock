defmodule StockWeb.Components.Menu do
  @moduledoc """
  The `StockWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  import StockWeb.Components.Accordion, only: [accordion: 1]
  import StockWeb.Components.Button, only: [button_link: 1]
