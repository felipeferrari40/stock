defmodule StockWeb.Components.Navbar do
  @moduledoc """
  The `StockWeb.Components.Navbar` module provides a flexible and customizable navigation
  ...
  @variants ["default", "shadow", "unbordered"]
