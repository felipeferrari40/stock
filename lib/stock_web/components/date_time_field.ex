defmodule StockWeb.Components.DateTimeField do
  @moduledoc """
  The `StockWeb.Components.DateTimeField` module provides a reusable component for rendering
  ...
  @variants ["outline", "default", "unbordered", "shadow", "transparent"]
