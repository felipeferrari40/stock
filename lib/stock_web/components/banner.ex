defmodule StockWeb.Components.Banner do
  @moduledoc """
  StockWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
