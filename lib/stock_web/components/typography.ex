defmodule StockWeb.Components.Typography do
  @moduledoc """
  The `StockWeb.Components.Typography` module provides components for rendering
  ...
  defp color("primary"), do: "text-[#4363EC]"

  defp color("secondary"), do: "text-[#6B6E7C]"

  defp color("success"), do: "text-[#227A52]"

  defp color("warning"), do: "text-[#FF8B08]"

  defp color("danger"), do: "text-[#E73B3B]"

  defp color("info"), do: "text-[#6663FD]"

  defp color("misc"), do: "text-[#52059C]"

  defp color("dawn"), do: "text-[#4D4137]"

  defp color("light"), do: "text-[#707483]"

  defp color("dark"), do: "text-[#1E1E1E]"
