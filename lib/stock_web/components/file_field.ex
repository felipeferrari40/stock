defmodule StockWeb.Components.FileField do
  @moduledoc """
  The `StockWeb.Components.FileField` module provides a versatile and customizable component
  ...
  import StockWeb.Components.Progress, only: [progress: 1]
