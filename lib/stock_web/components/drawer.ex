defmodule StockWeb.Components.Drawer do
  @moduledoc """
  The `StockWeb.Components.Drawer` module provides a flexible and customizable drawer component
  ...
  @variants ["default", "outline", "transparent", "shadow", "unbordered"]
