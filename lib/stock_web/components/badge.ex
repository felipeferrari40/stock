defmodule StockWeb.Components.Badge do
  @moduledoc """
  Provides customizable and flexible badge components for use in Phoenix LiveView.

  The `StockWeb.Components.Badge` module allows you to create badge elements with various styles,
  ...
  @variants ["default", "outline", "transparent", "unbordered", "shadow"]
  @colors [
    "white",
    "primary",
    "secondary",
