defmodule StockWeb.Components.Overlay do
  @moduledoc """
  The `StockWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `StockWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
