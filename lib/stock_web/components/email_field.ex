defmodule StockWeb.Components.EmailField do
  @moduledoc """
  The `StockWeb.Components.EmailField` module provides a customizable email input field
  ...
  @variants ["default", "outline", "unbordered", "shadow", "transparent"]
