defmodule StockWeb.Components.Spinner do
  @moduledoc """
  The `StockWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `StockWeb.Components.Spinner` module enables developers to provide
