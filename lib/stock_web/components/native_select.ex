defmodule StockWeb.Components.NativeSelect do
  @moduledoc """
  The `StockWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  @variants ["default", "outline", "transparent", "shadow", "unbordered", "native"]
