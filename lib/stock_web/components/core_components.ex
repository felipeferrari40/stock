defmodule StockWeb.CoreComponents do
  @moduledoc """
  ...
  Icons are provided by [faicons](https://faicons.com). See `icon/1` for usage.
  """
  ...
  def flash(assigns) do
    ...
    <div
      ...
      role="alert"
      class={[
        "fixed top-2 right-2 mr-2 w-80 sm:w-96 z-50 rounded-lg p-3 ring-1 z-50",
  ...
  @doc """
  Renders a [faicon](https://faicons.com).

  faicons come in three styles – outline, solid, and mini.
  ...
  Icons are extracted from the `deps/faicons` directory and bundled within
