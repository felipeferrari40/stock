defmodule StockWeb.Components.TableContent do
  @moduledoc """
  `StockWeb.Components.TableContent` is a component module designed to create flexible and dynamic
  ...
  defp color_variant("transparent", _), do: ["bg-transplant"]
